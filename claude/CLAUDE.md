...
3. More specific repository-level or directory-level CLAUDE.md instructions
4. This file
...
When context is compacted, preserve all of the following:
...
Never summarize away these rules:
